<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      //echo "Deposit successful! Your new balance is: " . $customer->getBalance();
      $success['deposit'] = "$".$amount. " deposited successfully.";
  }
?>
<!DOCTYPE html>
<html
