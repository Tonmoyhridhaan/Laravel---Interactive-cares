        ...
        <header class="py-10">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">
              Transactions of <?php echo getName($email);?>
            </h1>
          </div>
        </header>
      </div>
              ...
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  <p class="mt-2 text-sm text-gray-700">
                    List of transactions made by <?php echo getName($email);?>.
                  </p>
                </div>
              </div>
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td
                            ...
                            <?php echo $txn['otherEmail']; ?>
                          </td>
                          <?php
                              if (strpos($txn['amount'], '+') === 0) {
                                echo "<td
