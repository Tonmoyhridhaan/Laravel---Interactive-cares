<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($balance >= $amount) {
            ...
            $withdraw['success'] = "$".$amount." Withdrawal successful! " ;
        } else {
            $withdraw['insufficient'] = "Insufficient funds!";
        }
    }
?>
<!DOCTYPE html>
                    ...
                    <button
                      ...
                      <span
                        ...
                        <span class="font-medium leading-none text-emerald-700"
                          ><?php echo getFirstLetters($name); ?></span
                        >
                      </span>
                    </button>
                  </div>
