                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <ul
                    ...
                    if(config("storage.driver")=="file"){
                        $lines = file('../db/customers.txt');
                        foreach ($lines as $line) {
                        
                          if (preg_match('/Name:\s*(.+?),\s*Email:\s*(.+?),/', $line, $matches)) {
                              $name = $matches[1];
                              $email = $matches[2]; 
                          ?>
                    <li
                      ...
                      <div class="flex gap-x-4">
                        ...
                        <div class="flex-auto min-w-0">
                          <p
                            ...
                            <a href="./customer_transactions.php?email=<?php echo $email; ?>">
                              <span
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a
                              href="./customer_transactions.php?email=<?php echo $email; ?>"
